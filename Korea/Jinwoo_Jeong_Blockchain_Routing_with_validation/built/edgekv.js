...
var _EdgeKV_namespace, _EdgeKV_group, _EdgeKV_edgekv_uri, _EdgeKV_token_override;
...
export class EdgeKV {
     ...
     * @param {{namespace: string; group: string}} [namespace] the default namespace to use for all GET, PUT, and DELETE operations
    ...
    constructor(namespace = "default", group = "default") {
        _EdgeKV_namespace.set(this, void 0);
        _EdgeKV_group.set(this, void 0);
        _EdgeKV_edgekv_uri.set(this, void 0);
        _EdgeKV_token_override.set(this, void 0);
        if (typeof namespace === "object") {
            __classPrivateFieldSet(this, _EdgeKV_namespace, namespace.namespace || "default", "f");
            __classPrivateFieldSet(this, _EdgeKV_group, namespace.group || "default", "f");
            __classPrivateFieldSet(this, _EdgeKV_edgekv_uri, namespace.edgekv_uri || "https://edgekv.akamai-edge-svcs.net", "f");
            __classPrivateFieldSet(this, _EdgeKV_token_override, namespace.token_override || null, "f");
        }
        else {
            __classPrivateFieldSet(this, _EdgeKV_namespace, namespace, "f");
            __classPrivateFieldSet(this, _EdgeKV_group, group, "f");
            __classPrivateFieldSet(this, _EdgeKV_edgekv_uri, "https://edgekv.akamai-edge-svcs.net", "f");
            __classPrivateFieldSet(this, _EdgeKV_token_override, null, "f");
        }
    }
    ...
    getNamespaceToken(namespace) {
        if (__classPrivateFieldGet(this, _EdgeKV_token_override, "f")) {
            return __classPrivateFieldGet(this, _EdgeKV_token_override, "f");
        }
    ...
    putRequest({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, value, timeout = null } = {}) {
        this.validate({ namespace: namespace, group: group, item: item });
        let uri = __classPrivateFieldGet(this, _EdgeKV_edgekv_uri, "f") + "/api/v1/namespaces/" + namespace + "/groups/" + group + "/items/" + item;
     ...
     */
    async putText({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, value, timeout = null } = {}) {
     ...
     */
    putTextNoWait({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, value } = {}) {
        try {
     ...
     * 		an object describing the non-200 response from the EdgeKV: {failed, status, body}
     */
    async putJson({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, value, timeout = null } = {}) {
     ...
     * 		an object describing the error: {failed, status, body}
     */
    putJsonNoWait({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, value } = {}) {
        try {
    ...
    getRequest({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, timeout = null } = {}) {
        this.validate({ namespace: namespace, group: group, item: item });
        let uri = __classPrivateFieldGet(this, _EdgeKV_edgekv_uri, "f") + "/api/v1/namespaces/" + namespace + "/groups/" + group + "/items/" + item;
        return httpRequest(uri, this.addTimeout({
            method: "GET",
     ...
     */
    async getText({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, default_value = null, timeout = null } = {}) {
     ...
     * 		an object describing the non-200 and non-404 response from the EdgeKV: {failed, status, body}
     */
    async getJson({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, default_value = null, timeout = null } = {}) {
        return this.requestHandlerTemplate(() => this.getRequest({ namespace: namespace, group: group, item: item, timeout: timeout }), (response) => response.json(), (response) => this.streamJson(response.body), "GET JSON", default_value);
    }
    deleteRequest({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, timeout = null } = {}) {
        this.validate({ namespace: namespace, group: group, item: item });
        let uri = __classPrivateFieldGet(this, _EdgeKV_edgekv_uri, "f") + "/api/v1/namespaces/" + namespace + "/groups/" + group + "/items/" + item;
        return httpRequest(uri, this.addTimeout({
            method: "DELETE",
     ...
     * 		an object describing the non-200 response from the EdgeKV: {failed, status, body}
     */
    async delete({ namespace = __classPrivateFieldGet(this, _EdgeKV_namespace, "f"), group = __classPrivateFieldGet(this, _EdgeKV_group, "f"), item, timeout = null } = {}) {
...
_EdgeKV_namespace = new WeakMap(), _EdgeKV_group = new WeakMap(), _EdgeKV_edgekv_uri = new WeakMap(), _EdgeKV_token_override = new WeakMap();
